		...
		<form action="joinForm.user" method="post" name="reg_form">
			<table border="1">
				<tr>
					<td>아이디</td>
					<td>
						<input type="text" name="id" required pattern="[A-Z가-힣a-z0-9]{5,}">
					</td>
				</tr>
				<tr>
					<td>비밀번호</td>
				...
				<tr>
					<td>이메일</td>
					<td>
						<input type="text" name="email" placeholder="abc@def.com" required>
					</td>
				</tr>
				<tr>
					<td>주소</td>
				...
				<tr>
					...
					<td>
						...
						<input type="radio" name="gender"> 제3의성
					</td>
				</tr>
			</table>
			
			<br>
			<input type="submit" value="회원가입" class="bin bin-default">
