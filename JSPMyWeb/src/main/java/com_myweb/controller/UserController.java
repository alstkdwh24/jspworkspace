...
import com_myweb.user.service.UserService;
import com_myweb.user.service.UserServiceImpl;
...
public class UserController extends HttpServlet {
	...
	protected void doAction(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * 1. service영역의 delete메서드로 연결합니당
		 * 2. service에서는 먼저 login 메서드를 이용해서 회원의 정보를 조히ㅚ해서 가지고 나옵니다
		 * 4. 회원이 있다는 것은 비밀번호가 일치한다는 의미
